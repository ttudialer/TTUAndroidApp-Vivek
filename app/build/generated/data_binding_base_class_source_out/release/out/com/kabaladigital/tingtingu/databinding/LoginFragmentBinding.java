...
public abstract class LoginFragmentBinding extends ViewDataBinding {
  ...
  @NonNull
  public final LinearLayout layoutInputFields;
  ...
  protected LoginFragmentBinding(Object _bindingComponent, View _root, int _localFieldCount,
      Button btnNext, TextInputEditText etMobileNumber, TextInputEditText etReferralCode,
      LinearLayout layoutInputFields, TextView myTextView, TextView tvTitle) {
    super(_bindingComponent, _root, _localFieldCount);
    this.btnNext = btnNext;
    this.etMobileNumber = etMobileNumber;
    this.etReferralCode = etReferralCode;
    this.layoutInputFields = layoutInputFields;
