...
public class RedeemPointFragmentBindingImpl extends RedeemPointFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.radioGroup_reedem, 2);
        sViewsWithIds.put(R.id.radioBtn_mobile_recharge, 3);
        sViewsWithIds.put(R.id.radioBtn_dth_recharge, 4);
        sViewsWithIds.put(R.id.btn_redeem_continue, 5);
    }
    // views
    @NonNull
    ...
    public RedeemPointFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private RedeemPointFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
