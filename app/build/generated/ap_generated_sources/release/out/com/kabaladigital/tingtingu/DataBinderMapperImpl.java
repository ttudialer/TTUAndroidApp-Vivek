...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYONGOINGCALL = 5;

  private static final int LAYOUT_CHOOSELANGUAGEFRAGMENT = 6;

  private static final int LAYOUT_CHOOSEMULTILANGUAGEFRAGMENT = 7;

  private static final int LAYOUT_CHOOSEMULTILANGUAGEPROFILEFRAGMENT = 8;

  private static final int LAYOUT_CONGOREGISTRARTIONFRAGMENT = 9;

  private static final int LAYOUT_CONTACTLISTFRAGMENT = 10;

  private static final int LAYOUT_DTHPROCESSRECHARGEFRAGMENT = 11;

  private static final int LAYOUT_DTHRECHARGEFRAGMENT = 12;

  private static final int LAYOUT_EARNEDPOINTCREDITHISTORYFRAGMENT = 13;

  private static final int LAYOUT_EARNEDPOINTDEBITHISTORYFRAGMENT = 14;

  private static final int LAYOUT_EARNEDPOINTDEBITITEMS = 15;

  private static final int LAYOUT_EARNEDPOINTHISTORYFRAGMENT = 16;

  private static final int LAYOUT_ENDCALLADLAYOUT = 17;

  private static final int LAYOUT_ENTEROTFRAGMENT = 18;

  private static final int LAYOUT_FRAGMENTMEMBERSHIPMESSAGE = 19;

  private static final int LAYOUT_FRAGMENTRECHARGEHISTORY = 20;

  private static final int LAYOUT_INVITEFRIENDFRAGMENT = 21;

  private static final int LAYOUT_ITEMCONTACT = 22;

  private static final int LAYOUT_LAYOUTINCOMINGCALL = 23;

  private static final int LAYOUT_LAYOUTOPERATORHOME = 24;

  private static final int LAYOUT_LAYOUTRECENTRECHARGES = 25;

  private static final int LAYOUT_LAYOUTSURVEYLIST = 26;

  private static final int LAYOUT_LAYOUTWALLETBALANCE = 27;

  private static final int LAYOUT_LOGINFRAGMENT = 28;

  private static final int LAYOUT_MEMBERSHIPFRAGMENT = 29;

  private static final int LAYOUT_MOBILERECHARGEFRAGMENT = 30;

  private static final int LAYOUT_ONGOINGCALL = 31;

  private static final int LAYOUT_OPERATORDETAILFRAGMENT = 32;

  private static final int LAYOUT_OPERATORHOMEFRAGMENT = 33;

  private static final int LAYOUT_OPERATORSELECTFRAGMENT = 34;

  private static final int LAYOUT_OVERLAYSENDSMS = 35;

  private static final int LAYOUT_PROFILECHOOSEMULTILANGUAGEFRAGMENT = 36;

  private static final int LAYOUT_PROFILEFRAGMENT = 37;

  private static final int LAYOUT_PROFILESTEP1FRAGMENT = 38;

  private static final int LAYOUT_PROFILESTEP2FRAGMENT = 39;

  private static final int LAYOUT_RECHARGEAMOUNTFRAGMENT = 40;

  private static final int LAYOUT_REDEEMPOINTFRAGMENT = 41;

  private static final int LAYOUT_REGISTRATIONFRAGMENT = 42;

  private static final int LAYOUT_REGISTRATIONSTEP2FRAGMENT = 43;

  private static final int LAYOUT_SETTINGFRAGMENT = 44;

  private static final int LAYOUT_SPLASHSCREENFRAGMENT = 45;
