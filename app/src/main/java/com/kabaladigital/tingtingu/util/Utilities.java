...
Utilities {
        ...
        try {
            if (!activity.getSystemService(TelecomManager.class).getDefaultDialerPackage().equals(packageName)) {
               ...
               // Intent intent = new Intent(TelecomManager.ACTION_CHANGE_DEFAULT_DIALER)
                ...
                @SuppressLint("WrongConstant") RoleManager rm = (RoleManager) activity.getSystemService(Context.ROLE_SERVICE);
    ...
    public static boolean checkDefaultDialerOnly(Activity activity) {
        String packageName = activity.getApplication().getPackageName();
        try {
            return activity.getSystemService(TelecomManager.class).getDefaultDialerPackage().equals(packageName);
        } catch (Exception e) {
            return false;
        }
    }
