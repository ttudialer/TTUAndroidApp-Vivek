...
import com.kabaladigital.tingtingu.ui.fragment.base.AbsBaseFragment;
...
public class DialpadFragment extends AbsBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PreferenceUtils.getInstance(getContext(),false);
...
//                    ((OldMainActivity) DialpadFragment.this.getActivity()).expandDialer(true);
                    return true;
                }
            };
