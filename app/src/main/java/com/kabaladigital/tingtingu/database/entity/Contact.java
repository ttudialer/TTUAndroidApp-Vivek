...
public class Contact {
    ...
    @Ignore private int type; // No need to save this to the database
     ...
     * @param phoneNumber the contact's phone number
     * @param photoUri    the contact's image
     * @param type         the contact's phone number type
     */
    @Ignore
    public Contact(String name, @NonNull String phoneNumber, @Nullable String photoUri, @Nullable int type) {
        this.name = name;
        this.photoUri = photoUri;
        this.phoneNumbers = new ArrayList<>();
        this.phoneNumbers.add(phoneNumber);
